...
<body>
    <div class="navbar navbar-default" style="background-color: #e3f2fd;">
        <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo site_url('');?>"><strong>Sistem Informasi Perpustakaan</strong></a>
        </div>
...
<div class="row">
    <div class="col-md-4">
        <div class="panel panel-default">
            <div class="panel-heading">
                <span class="glyphicon glyphicon-lock"></span> <strong>LOGIN STAFF</strong>
            </div>
    ...
    <div class="col-md-8 ">
        <h4> Selamat datang di Sistem Informasi Perpustakaan</h4><hr class="line-title"> 
